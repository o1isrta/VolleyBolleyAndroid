...
val referenceDataModule = module {
    ...
    single<NetworkClient<ReferenceDataRequest, ReferenceDataResponse>>(HttpClientQualifier.REFERENCE_DATA.qualifier) { ReferenceDataNetworkClient() }
    ...
    single<ReferenceDataLocalRepository> { ReferenceDataLocalRepositoryImpl(json = get(), cacheDir = get()) }
