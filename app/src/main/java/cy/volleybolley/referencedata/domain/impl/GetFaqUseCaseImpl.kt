...
class GetFaqUseCaseImpl(private val referenceDataRemoteRepository: ReferenceDataRemoteRepository) : GetFaqUseCase {
    override fun execute(): Flow<VolleyResult<Faq, ErrorType>> {
        return referenceDataRemoteRepository.getFaq()
    }
}
