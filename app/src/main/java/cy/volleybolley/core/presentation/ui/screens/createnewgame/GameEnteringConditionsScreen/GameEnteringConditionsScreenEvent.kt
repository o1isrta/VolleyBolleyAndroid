...
sealed class GameEnteringConditionsScreenEvent : UiEvent {
    ...
    data class MaximumPlayersChanged(val maximumPersons: Int) : GameEnteringConditionsScreenEvent() // Увеличение или уменьшение maximumPlayers
    data class RemovePlayer(val index: Int) : GameEnteringConditionsScreenEvent()                   // нажатие на кнопку "Удалить игрока из игры"
}
